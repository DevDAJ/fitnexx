...
const exercises: ExerciseSeed[] = [
  // ── Chest ──
  {
    ...
    requiredEquipmentIds: ["eq-barbell", "eq-flat-bench"],
  },
  {
    id: "ex-incline-bench",
    name: "Incline Bench Press",
    muscleGroupName: "Chest",
    requiredEquipmentIds: ["eq-barbell", "eq-incline-bench"],
  },
  {
    id: "ex-decline-bench",
    name: "Decline Bench Press",
    muscleGroupName: "Chest",
    requiredEquipmentIds: ["eq-barbell", "eq-decline-bench"],
  },
  {
    id: "ex-dumbbell-bench",
    name: "Dumbbell Bench Press",
    muscleGroupName: "Chest",
    requiredEquipmentIds: ["eq-dumbbells", "eq-flat-bench"],
  },
  {
    id: "ex-incline-dumbbell",
    name: "Incline Dumbbell Press",
    muscleGroupName: "Chest",
    requiredEquipmentIds: ["eq-dumbbells", "eq-incline-bench"],
  },
  {
    id: "ex-dumbbell-fly",
    name: "Dumbbell Fly",
  ...
  },
  {
    ...
    name: "Cable Fly",
    muscleGroupName: "Chest",
    requiredEquipmentIds: ["eq-cable-machine"],
  },
  {
    id: "ex-push-up",
    name: "Push-up",
  ...
  },
  {
    ...
    name: "Pec Deck Fly",
    muscleGroupName: "Chest",
    requiredEquipmentIds: ["eq-pec-deck"],
  },
  {
    id: "ex-dip-chest",
    name: "Chest Dip",
    muscleGroupName: "Chest",
    requiredEquipmentIds: ["eq-dip-bars"],
  },
  ...
  },
  {
    ...
    name: "Deadlift",
    muscleGroupName: "Back",
    requiredEquipmentIds: ["eq-barbell", "eq-plates"],
  },
  {
  ...
  // ── Legs ──
  {
    ...
    requiredEquipmentIds: ["eq-barbell", "eq-power-rack"],
  },
  {
    id: "ex-front-squat",
    name: "Front Squat",
  ...
  },
  {
    ...
    name: "Goblet Squat",
    muscleGroupName: "Legs",
    requiredEquipmentIds: ["eq-kettlebell"],
  },
  {
    id: "ex-lunges",
    name: "Lunges",
  ...
  },
  {
    ...
    name: "EZ Bar Curl",
    muscleGroupName: "Arms",
    requiredEquipmentIds: ["eq-ez-bar"],
  },
  {
    id: "ex-preacher-curl",
    name: "Preacher Curl",
    muscleGroupName: "Arms",
    requiredEquipmentIds: ["eq-dumbbells", "eq-preacher-bench"],
  },
  {
    id: "ex-cable-curl",
    name: "Cable Curl",
  ...
  },
  {
    ...
    name: "Skull Crusher",
    muscleGroupName: "Arms",
    requiredEquipmentIds: ["eq-ez-bar", "eq-flat-bench"],
  },
  {
  ...
  },
  {
    ...
    muscleGroupName: "Core",
    requiredEquipmentIds: ["eq-ab-wheel"],
  },
  {
  ...
  },
  {
    ...
    name: "Weighted Plank",
    muscleGroupName: "Core",
    requiredEquipmentIds: ["eq-plates"],
  },
  {
    id: "ex-pallof-press",
    name: "Pallof Press",
  ...
  },
  {
    ...
    muscleGroupName: "Core",
    requiredEquipmentIds: ["eq-exercise-bike"],
  },
  {
    id: "ex-rowing-machine",
    name: "Rowing Machine",
    muscleGroupName: "Core",
    requiredEquipmentIds: ["eq-rowing-machine"],
  },
  {
    id: "ex-elliptical",
    name: "Elliptical",
    muscleGroupName: "Core",
    requiredEquipmentIds: ["eq-elliptical"],
  },
  {
    id: "ex-stair-climber",
    name: "Stair Climber",
    muscleGroupName: "Core",
    requiredEquipmentIds: ["eq-stair-climber"],
  },
  {
    id: "ex-jump-rope",
    name: "Jump Rope",
    muscleGroupName: "Core",
    requiredEquipmentIds: ["eq-jump-rope"],
  },
];
