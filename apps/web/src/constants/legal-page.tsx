    ...
    pointsOfInterest: [
      {
        ...
        content: (
          <p>
            ...
            ; we <strong className="text-foreground">do not retain</strong>{" "}
            those inputs or outputs after that processing completes, except
            where a separate, narrowly scoped technical log is strictly required
            for security or abuse prevention (and minimized). OCR and nutrition
      ...
      },
      {
        ...
        content: (
          <p>
            ...
            body measurement streams processed on our server-side OCR processing
            are not provided to third parties for their own model training.
            Where we use other infrastructure or service providers
            (&ldquo;processors&rdquo;) for disjoint services (e.g. hosting,
            billing, or support mail), they process under contractual terms. We
            may disclose information if required by law or to protect rights and
            safety.
          </p>
        ),
      },
