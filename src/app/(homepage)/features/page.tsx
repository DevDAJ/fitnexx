        ...
        <section className="border-b border-border/60 bg-linear-to-b from-primary/5 via-background to-background px-4 py-12 sm:px-6 sm:py-16">
          <div className="mx-auto max-w-5xl">
            ...
            <p className="text-muted-foreground max-w-2xl text-base leading-relaxed sm:text-lg">
              ...
              suggestions plus a daily meal AI overview alongside higher OCR
              caps; body measurements stay included on Free. Personal
              information isn&apos;t saved for OCR improvement.
            </p>
          </div>
        </section>
              ...
              <CardHeader className="sm:flex-row sm:items-center sm:justify-between sm:gap-6">
                <div>
                  ...
                  <CardDescription className="mt-1 text-base">
                    Start from the home page or open the app when you&apos;re
                    set.
                  </CardDescription>
                </div>
