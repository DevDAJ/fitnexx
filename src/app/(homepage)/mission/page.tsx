        ...
        >
          <div className="mx-auto max-w-3xl space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed sm:text-base">
              ...
              endless notifications, or shadow profiles built from your plate
              and your PRs. Fitnexx aims to be the calm layer between your real
              life and your numbers, local-first where it makes sense,
              transparent where the cloud helps, and always bound to policies
              you can read and rights you can exercise.
            </p>
          </div>
        </section>
        ...
        >
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed sm:text-base">
              ...
              your life. It means{" "}
              <strong className="text-foreground">control</strong>: clear
              settings and documents instead of dark patterns. And for OCR, it
              means we don&apos;t save personal information to “improve the
              model” in ways that turn your photos into someone else&apos;s ad
              graph.
            </p>
            <p className="text-muted-foreground text-sm leading-relaxed sm:text-base">
            ...
            <div className="bg-muted/40 ring-foreground/5 mt-8 space-y-4 rounded-xl p-6 ring-1">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Read how we process data and cookies, or reach out before you
                roll in hard on a subscription.
              </p>
