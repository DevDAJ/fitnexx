      ...
      <section className="border-b border-border/60 bg-linear-to-b from-primary/5 via-background to-background px-4 py-16 sm:px-6 sm:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl text-base leading-relaxed sm:text-lg">
            ...
            OCR macro tracking, and includes free body measurement tracking;
            photo and macro fixes improve recognition without saving personal
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Button variant="outline" size="lg" asChild>
              <Link href="/mission">Why privacy</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-5xl">
              ...
              <CardContent>
                <ul className="space-y-4">
                  ...
                  <li className="flex gap-3">
                    ...
                    />
                    <div>
                      <p className="font-medium">OCR learning, no PI stored</p>
                      <p className="text-muted-foreground text-sm">
          ...
          <div className="border-border/60 mt-10 flex flex-wrap gap-3 border-t pt-10">
            ...
            <Button variant="outline" asChild>
              <Link href="/mission#why-privacy">Why privacy (full story)</Link>
            </Button>
            <Button variant="outline" asChild>
