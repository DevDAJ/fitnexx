      ...
      <Button
        ...
        className={
          cn(
            ...
            isLight && "bg-orange-300 text-orange-950 drop-shadow-sm hover:bg-orange-400 hover:text-orange-950",
          )
        }
      ...
      <Button
        ...
        className={
          cn(
            ...
            isDark && "bg-indigo-300 text-indigo-950 drop-shadow-sm hover:bg-indigo-400 hover:text-indigo-950",
          )
        }
